...
export default function KineticAppFlow() {
  return (
...
<input className="w-full bg-surface-container-lowest text-on-surface font-body text-base px-12 py-4 rounded-lg border-b-2 border-transparent focus:border-b-primary outline-none transition-all placeholder:text-on-surface-variant/50" id="mobile" placeholder="+1 (555) 000-0000" type="tel"/>
</div>
</div>
...
<button onClick={() => alert('Interactive feature coming soon!')} className="w-full mt-4 bg-primary text-on-primary font-headline font-bold text-lg py-4 rounded-xl shadow-[0_0_24px_rgba(165,255,184,0.15)] hover:shadow-[0_0_32px_rgba(165,255,184,0.25)] hover:bg-primary-container transition-all flex items-center justify-center gap-2" type="button">
<span>ENTER ARENA</span>
<span className="material-symbols-outlined font-bold" data-icon="arrow_forward" style={{ fontVariationSettings: "'wght' 700" }}>arrow_forward</span>
</button>
</form>

<div className="text-center mt-4">
<a className="font-body text-sm text-secondary hover:text-primary transition-colors" href="#">Need help finding your ticket?</a>
</div>
</div>
</main>
